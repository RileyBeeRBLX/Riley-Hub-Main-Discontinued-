...
local Window = OrionLib:MakeWindow({Name = "Riley Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "RileyHub"})
...
local Tab = Window:MakeTab({
	Name = "Mimic Script Section (Testing)",
